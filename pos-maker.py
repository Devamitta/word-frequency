...
# save adv csv
df_time[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/adv_time.csv", sep="\t", index=None)

df_place[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/adv_place.csv", sep="\t", index=None)

df_interr[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/adv_interr.csv", sep="\t", index=None)
...
df_name[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/names.csv", sep="\t", index=None)
...
# save all done
df[['Pāli1', 'Pattern', 'count']].to_csv("curated-sources/frequent-words.csv", sep="\t", index=None)
...
df_a_masc[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/masc-a.csv", sep="\t", index=None)

df_i_masc[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/masc-i.csv", sep="\t", index=None)

df_ii_masc[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/masc-ī.csv", sep="\t", index=None)

df_u_masc[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/masc-u.csv", sep="\t", index=None)

df_uu_masc[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/masc-ū.csv", sep="\t", index=None)

df_ar_masc[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/masc-ar.csv", sep="\t", index=None)
...
# save ant csv
df_ant[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/masc-ant.csv", sep="\t", index=None)
...
df_ati_pr[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/pr-ati.csv", sep="\t", index=None)

df_eti_pr[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/pr-eti.csv", sep="\t", index=None)

df_aati_pr[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/pr-āti.csv", sep="\t", index=None)

df_oti_pr[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/pr-oti.csv", sep="\t", index=None)

df_be_pr[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/pr-be.csv", sep="\t", index=None)
...
# save other pr csv
df_other_pr[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/pr-other.csv", sep="\t", index=None)
...
# save aor
df_i_aor[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/aor-i.csv", sep="\t", index=None)

df_esi_aor[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/aor-esi.csv", sep="\t", index=None)

df_aasi_aor[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/aor-āsi.csv", sep="\t", index=None)

df_be_aor[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/aor-be.csv", sep="\t", index=None)
...
# save other aor csv
df_other_aor[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/aor-other.csv", sep="\t", index=None)
...
# save 1&2 pron
df_pers_pron[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/pron_pers.csv", sep="\t", index=None)
...
# save other aor csv
df_other_pron[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/other-pron.csv", sep="\t", index=None)
...
# save fut csv
df_fut[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/fut.csv", sep="\t", index=None)
...
df_summary[['Pāli1', 'Pattern', 'count']].to_csv("frequent-words/summary.csv", sep="\t", index=None)
